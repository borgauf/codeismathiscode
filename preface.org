...
#+begin_quote
@@html:<font color = "#650d1c" size = "5%">@@...there is no magic, no
special effects, no superheroes with super-human powers, no hip,
genius grade-schooler who hacks Pentagon computers in three seconds;
instead, just a bunch of ordinary-looking people from disparate
backgrounds putting their heads together to solve a critical
problem.@@html:</font>@@
#+end_quote
...
mainframe computer (that no one knows how to run) to help them crunch
the numbers.
...
tables, on classroom and office blackboards, embedded in mechanical
...
** A concept-based, real-world approach
