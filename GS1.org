...
already made online purchases of the main text for the course, /The
Haskell Road to Logic, Maths and Programming/ by Kees Doets and Jan
van Eijck. During the open house at student center on the previous
Saturday, they had sat down with the professor and gone over the book,
she talking extemporaneously about what parts she would like to handle
and how. The professor encouraged them to dive into to the logic and
sets prereqs noted on her website, as well as to get through as much
/Learn You a Haskell.../ as possible. They would eventually look into
other languages, but the first stop would be Haskell.

Ursula von der Surwitz has plugged in her laptop to the room's big 4K
monitor and scrolls through some of her personal notes.

@@html:<span class="fraktur">@@𝔘𝔯𝔰𝔲𝔩𝔞:@@html:</span>@@ So like
Professor Chandra said on Saturday, we're going to rely on logic and
set theory. \\
...
showing us in the book, you need set theory to properly define
...
blended together. \\
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ But I'm glad I've
already seen the prime factorization way of figuring out
unlike-denominator math back in Kiel. /If/ I can remember it. \\
[affirmative murmurs] \\
...
Adriansen, our Geometry teacher, Danish minority from Schleswig. Cool
accent. Made fun of Frisians. He gave us that little talk about why
old-school Euclidean Geometry was so important. \\
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ Yes, because you
have to get used to the idea that math is built up from logical
deductions that in turn are based on axioms. It's not magic, it's
logic. \\
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ He complained
bitterly about how math was being taught these days, how it was
sliding into just circus animals learning by conditioning. \\
...
[fn:2] Take a break and check out [[file:AxiomsTheoremsProof.html][this]] theory treatment.
